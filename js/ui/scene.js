...
const QUIPS = {
  ...
  researcher: [
    ...
    'Correlation isn\'t causation, but it IS a NeurDips paper.',
  ...
  engineer: [
    ...
    'I speak four languages: Python, KUDA, YAML, apology.',
  ...
  sales: [
    ...
    'A rival called us "niche". We prefer "focused". Drafting a friendly reply.',
